      ...
      <section class=" bg-slate-50 py-10" id="skills">
        <div class="container">
          ...
          <p class="mt-5 poppins-light text-[0.9rem]">
            <q>
              I have two years of experience in the software development
              industry. I've worked on various projects including property
              systems, care systems, and contributed to several others.
              Additionally, I'm currently learning Japanese at the N3 level.
            </q>
          </p>
          <Skill />
        </div>
            ...
            <div>
              ...
              <div class="border-l-4 border-l-slate-400 pl-5 resume relative">
                ...
                <p class="poppins-light text-[0.9rem] pb-3">
                  ...
                  During my time at the university, I learned several
                  technologies including HTML, CSS, JavaScript, SQL, and others.
                </p>
              </div>
            ...
            <div>
              ...
              <div class="border-l-4 border-l-slate-400 pl-4 resume relative">
                ...
                <p class="poppins-light text-[0.9rem] pb-3">
                  ...
                  responsible for reporting bugs, conducting tests, and
              ...
              <div class="border-l-4 border-l-slate-400 pl-4 resume relative">
                ...
                <p class="poppins-light text-[0.9rem]">
                  After graduating, I completed a three-month on-the-job
                  training at Myanmar IT Consulting Co., Ltd, Innocreation Co.,
                  Ltd and BIB Training Center.
                </p>
              </div>
            </div>
          </div>
